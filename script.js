...
const clubsJunior = [
    ...
    { name: "นาฏศิลป์ (นายเอกชัย แตบสวัสดิ์ / นางสาวศุุภิสรา กลิ่นหอม )", capacity: 35 },
    { name: "วงโยธวาทิต (นายรุ่งโรจน์ ศรีสังข์ / นายยงยศ สง่าวงษ์)", capacity: 25 },
    { name: "ว่ายน้ำ (นางสาววารินทร์ เกตุเกลี้ยง / นางสาวเบญญทิพย์ เขียวราชา)", capacity: 26 },
    { name: "ส่งเสริมประชาธิปไตย (นางสาวศิริรัตน์ สงวนศรี / นายอาชวิน สร้อยจิต)", capacity: 6, adminOnly: true },
    { name: "จินตคณิต ม.ต้น (นางสาวกรรณิกา ชินวิวัฒนผล / นางสาวนันทวัน สิงห์สังข์)", capacity: 15 },
    { name: "วิทยากรรุ่นเยาว์ ม.ต้น (นายรุ่งโรจน์ ติดมา)", capacity: 15 },
    { name: "วิทย์น่าสนุก ม.ต้น (นางสาวกวิสรา ทรงอาวุธ)", capacity: 15 },
    { name: "French for the neighborhood of Sao Ching Cha ม.ต้น (นางสาวกานต์ชนก สมภักดี / นายวรพล ขำปาน)", capacity: 15 },
    { name: "TED Talks x BR ม.ต้น (นางสาวดารากันย์ เจริญจิต / นางสาวนิตยา อาจเดช)", capacity: 15 },
...
const clubsSenior = [
    ...
    { name: "นาฏศิลป์ ม.ปลาย(นายเอกชัย แตบสวัสดิ์ / นางสาวศุุภิสรา กลิ่นหอม)", capacity: 25 },
